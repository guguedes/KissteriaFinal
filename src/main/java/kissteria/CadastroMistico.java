...
private String tipoEscolhido;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String[] opcoesTiposPersonagem = {"bruxo", "demonio"};
        ...
        private String obterCaminhoImagemParaTipo(String tipo) {
            ...
            mapeamentoTipos.put("bruxo", "src/main/resources/bruxo.png");
            mapeamentoTipos.put("demonio", "src/main/resources/demonio.png");
    ...
    private void salvar(Mistico guerreiro) {
        String sql = "INSERT "
                + "INTO `tb_mistico` "
                + "(`nome`, `pontosVida`, `pontosAtaque`, `pontosDefesa`, `tipoPersonagem`, `inteligencia`, `recuperacao`) "
                + "VALUES "
                + "(?, ?, ?, ?, ?, ?, ?);";
        try {
            ...
            preparacaoDaInstrucao.setString(5, guerreiro.getTipoPersonagem()); // Adiciona o tipoPersonagem
            preparacaoDaInstrucao.setInt(6, guerreiro.getInteligencia());
            preparacaoDaInstrucao.setInt(7, guerreiro.getRecuperacao());
